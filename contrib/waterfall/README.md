...
- **Clear cache**: removes all per-radio `/tmp` caches; hover shows space freed
...
1. Build `waterfall-0.2.35-r0.apk`
2. Prefer SSH once when leaving older builds: `apk add --allow-untrusted waterfall-0.2.35-r0.apk`
