...
- Package: `babel-monitor-0.1.8-r0.apk`
...
APK lands in `dist/babel-monitor-0.1.8-r0.apk`.
...
```sh
apk add --allow-untrusted /tmp/babel-monitor-0.1.8-r0.apk
```
